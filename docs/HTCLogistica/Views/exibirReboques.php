...
<head>
    ...
    <link rel="stylesheet" href="../css/styleTableReboque.css" />
    <link rel="stylesheet" href="../css/modal.css" />
    <title>EXIBIR REBOQUES</title>
</head>
        ...
        <div class="container-area">
            <div class="container-area2">
                <div class="container-pesquisa">
                    <input type="text" name="placar" id="placar" placeholder="Digite para pesquisar">
                </div>
