    ...
    <div class="container">
        <div class="container-area">
            <div class="container-button">
                ...
                <button id="relatorio" class="frota" onclick="window.location.href = 'relatorio.php?datahora='">RELAT&Oacute;RIOS</button>
                <button id="sair" class="sair" onclick="window.location.href = 'sair.php'">SAIR</button>
            </div>
        </div>
    </div>
</body>
