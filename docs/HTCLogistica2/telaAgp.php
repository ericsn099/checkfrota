            ...
            <form class="form" action="cadastrar_checklist.php" method="post">
                    ...
                    <div class="container-motorista">
                        <label class="label-input">
                            <select class="ui-select-style" id="sl_motorista" name='cmmotorista' required>
                                <option value='' id='motorista'>MOTORISTA</option>
                                <?php
                                include "conexao.php";
                                ...
                                while ($linha = mysqli_fetch_assoc($dados)) {
                                    $nome = $linha['nome'];
                                    echo "<option  value='" . $linha['id'] . "' id='motorista'> $nome </option>";
                                }
                                ?>
                            </select>
                        </label>
                ...
                <div class="container-rodape">
                    <div class="container-text-area">
                        ...
                        <textarea name="obs" id="obs" placeholder="OBSERVA&Ccedil;&Atilde;O" style="display:none"></textarea>
                        <textarea name="sig" id="sig" style="display:none"></textarea>
                    </div>
                    <div class="container-pai-button">
                        <div class="container-button">
                            <button class="frota" id="cadastrar">CADASTRAR</button>
                            <button id="sair" class="frota" name="sair" onclick="window.location.href = 'sair.php'">SAIR</button>
                        </div>
                    </div>
                </div>
            </form>
