    ...
    <div class="container">
        <div class="container-area">
            <div class="container-form">
                ...
                <form class="form" action="/semiReboque/form/save" method="post">
                    <input type="hidden" name="id" value="<?= $model->id ?>">
                    <label class="label-input">
                        <input type="text" id="placa" placeholder="Placa" value="<?= $model->placar ?>" name="placar" required>
                    </label>
                    ...
                    <label class="label-input">
                        <select class="ui-select-style" id="cmtipocarro" name='cmtipocarro' size=1 required>
                            <?php foreach ($modelTipoSemiReboque->rows as $item) : ?>
                ...
                <div class="container-button">
                    <a href="/semiReboque" class="frota" id="voltar">VOLTAR</a>
                </div>
            </div>
        </div>
    </div>
...
if (isset($_GET['message'])) {
    include 'Views/feedbackSemiReboque/salvar.php';
}
?>