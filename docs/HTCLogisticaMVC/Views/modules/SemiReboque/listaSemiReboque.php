        ...
        <div class="container-area">
            <div class="container-area2">
                    ...
                    <table class="tg">
                        <thead>
                            <tr>
                                ...
                                <th class="tg-th">TIPO SEMI REBOQUE</th>
                        ...
                        <tbody>
                            <?php foreach ($model->rows as $item) : ?>
                                <tr>
                                    <th class="tg-th"><?= $item->placar ?></th>
                                    <th class="tg-th"><?= $item->nome ?></th>
                                    <th class="tg-th"><a href="/semiReboque/form?id=<?= $item->id ?>">ALTERAR</a></th>
                                    <th class="tg-th"><a href="/semiReboque/delete?id=<?= $item->id ?>">EXCLUIR</a></th>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
                ...
                <div class="container-button">
                    <a href="/semiReboque/form" id="cadastrar" class="frota">CADASTRO</a>
...
if (isset($_GET['message'])) {
    include 'Views/feedbackSemiReboque/excluir.php';
}
?>