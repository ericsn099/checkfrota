...
<head>
    ...
    <title>Cadastro de ocorr&ecirc;ncia</title>
</head>
<?php
include "conexao.php";
            ...
            <form action="cadastro_ocorrencia.php" method="POST">
                <div class="form-img">
                    <div class="form-img-area">
                        <img src="css/img/logo_css.png" alt="Imagem logo">
                    </div>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    <label for="">Tipo de Ocorr&ecirc;;ncia</label>
                ...
                <div class="botoes">
                    ...
                    <button><a href="index.php"> Ocorr&ecirc;ncias </a></button>
                </div>
